...
namespace YammerEmbedWebpart.Webparts.YammerLike
{
	/*Yammer Action button documentation: https://developer.yammer.com/v1.0/docs/open-graph-buttons */
	/*
	 * When an open graph object is created for a page/file that is "liked", Yammer used embed.ly to pull open graph properties from Title and Meta data
	 * Meta data fields referenced at: https://developer.yammer.com/v1.0/docs/embedly
	 * 
	 */
	[ToolboxItemAttribute(false)]
	public class YammerLike : WebPart
	{
		...
		WebDescription("An unique selector for this instance, i.e. #embedded-like. Leave blank for default.")]
		...
		*/
		private String GenerateYammerActionJavaScript()
		{
			...
			sbReturn.Append("function loadYammerActionLike() {\r\n");
